...
import BannerImage from 'assets/collage.png';
import PartnerImage from 'assets/countries.svg';
        ...
        <Flex sx={styles.banner.row}>
          <Box sx={styles.banner.col}>
            <Box sx={styles.banner.content}>
              ...
              <Heading as="h3">
                Learn African Language <br />
                Conviniently
              </Heading>
              <Text as="p">
               Henguage is an african language-learning website and mobile app where users learn 
               a new language through quick lessons, live online classes, podcast and more.
              </Text>
